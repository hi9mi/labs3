...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("Введите температуру воды, пригодную для купания (по умолчанию 22°C): ");
        String inputTemp = scanner.nextLine().trim();
        int swimmingTemp = inputTemp.isEmpty() ? DEFAULT_SWIMMING_TEMP : Integer.parseInt(inputTemp);
        ...
        System.out.println("Больше всего тёплых дней было в " + (maxIndex + 1) + " декаде сентября");
