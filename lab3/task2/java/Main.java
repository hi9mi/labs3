...
public class Main {
  ...
  public static int readSwimmingTemp(Scanner scanner, int defaultTemp) {
    System.out.print("Введите температуру воды, пригодную для купания (по умолчанию "
        + defaultTemp + "°C): ");
  ...
  public static void printResults(int suitableDays, int maxDecade) {
    ...
    System.out.println("Больше всего тёплых дней было в " + maxDecade + " декаде сентября");
  }
}
